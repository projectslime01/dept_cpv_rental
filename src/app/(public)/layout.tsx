        ...
        <header className="bg-[#0f0e11] border-b border-[#2a2830] sticky top-0 z-40">
          <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-0.5 text-sm font-medium">
              <a href="/" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[#9b8f91] hover:text-[#e5e2e1] hover:bg-[#201f21] transition-all duration-150">
                <List className="w-3.5 h-3.5" />
                <span>기자재 목록</span>
              </a>
              <a href="/status" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[#9b8f91] hover:text-[#e5e2e1] hover:bg-[#201f21] transition-all duration-150">
