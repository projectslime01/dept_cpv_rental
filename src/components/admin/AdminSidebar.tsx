...
import { LayoutDashboard, ClipboardList, ClipboardPlus, Package, Building2, DoorOpen, History, Users, TestTube2, BookOpen, Ban, GraduationCap } from 'lucide-react'

const NAV_ITEMS = [
  { href: '/admin/dashboard',      label: '대시보드',    icon: LayoutDashboard },
  { href: '/admin/requests',       label: '기자재 신청', icon: ClipboardList },
  { href: '/admin/classroom',      label: '강의실 신청', icon: DoorOpen },
  { href: '/admin/manual-request', label: '수동 등록',   icon: ClipboardPlus },
